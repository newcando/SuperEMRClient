...
class mydoctorTableViewController: UITableViewController {
...
//        let xString : String = xNSNumber.stringValue
        ...
        let chatWith = RCConversationViewController(conversationType: RCConversationType.ConversationType_PRIVATE, targetId:xString )
...
//                                                })
    ...
    */
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("mydoctorTableCell", forIndexPath: indexPath) as! mydoctorTableViewCell
...
//        self.loginRongCloud( indexPath.row as Int)
        ...
        var vc = sb.instantiateViewControllerWithIdentifier("chatViewControllerPatient") as! chatViewControllerPatient
        let nickname : String = self.doctors[indexPath.row as Int]["nickname"] as! String
        let user = self.doctors[indexPath.row as Int]["user"] as! Int
        let avator = self.doctors[indexPath.row as Int]["user_image"] as! String
        vc.user = user
        vc.avator = avator
        vc.username = nickname
        vc.loginUser = self.user
